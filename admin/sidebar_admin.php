  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" >
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="adm.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="refund.php" class="nav-link">
              <i class="nav-icon far bi bi-cash-coin icon-side"></i>
              <p>
               คืนเงิน
                <!-- <span class="badge badge-info right">2</span> -->
              </p>
          ...
          <li class="nav-item">
            <a href="apppv.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="sumresults.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="namage_user.php" class="nav-link">
              <i class="nav-icon far fa fa-users icon-side"></i>
              <p>
              จัดการข้อมูลผู้ใช้
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="qr.php" class="nav-link">
              <i class="nav-icon far fa fa-chart-pie icon-side"></i>
              <p>
              สรุปสถิติ
              </p>
            </a>
